...
#create method to calculate cat scores/total scores 
    ...
    batter_pa = Column(Float, default = 0)
    batter_ab = Column(Float, default = 0)
    batter_hit = Column(Float, default = 0)
    batter_single = Column(Float, default = 0)
    batter_double = Column(Float, default = 0)
    batter_triple = Column(Float, default = 0)
    batter_hr = Column(Float, default = 0)
    batter_bb = Column(Float, default = 0)
    batter_sb = Column(Float, default = 0)
    batter_cs = Column(Float, default = 0)
    batter_k = Column(Float, default = 0)
    batter_r = Column(Float, default = 0)
    batter_rbi = Column(Float, default = 0)
    ...
    batter_xbh = Column(Float, default = 0)
...
class Scoring(Base):
    ...
    batter_r = Column(Float, default = 0)
    batter_rbi = Column(Float, default = 0)
    batter_errors = Column(Float, default = 0)
    batter_gidp = Column(Float, default = 0)
    batter_hbp = Column(Float, default = 0)
    batter_xbh = Column(Float, default = 0)
    pitcher_w = Column(Float, default = 0)
    pitcher_l = Column(Float, default = 0)
    pitcher_ip = Column(Float, default = 0)
